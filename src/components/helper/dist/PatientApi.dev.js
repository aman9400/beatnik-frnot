...
var getFamilyDoctorDetailByUid = function getFamilyDoctorDetailByUid(data) {
  ...
  return regeneratorRuntime.async(function getFamilyDoctorDetailByUid$(_context4) {
    while (1) {
...
var getFamilyDependentByUid = function getFamilyDependentByUid(data) {
  ...
  return regeneratorRuntime.async(function getFamilyDependentByUid$(_context5) {
    while (1) {
...
var getDependentMedicalHistory = function getDependentMedicalHistory(data) {
  var loginToken, myHeaders, bearerTokern, requestOptions, response, regResponse;
  return regeneratorRuntime.async(function getDependentMedicalHistory$(_context6) {
    while (1) {
...
var addFamilyMember = function addFamilyMember(data) {
  ...
  return regeneratorRuntime.async(function addFamilyMember$(_context7) {
    while (1) {
...
var addFamilyDoctorDetail = function addFamilyDoctorDetail(data) {
  var loginToken, myHeaders, bearerTokern, recordData, requestOptions, response, regResponse;
  return regeneratorRuntime.async(function addFamilyDoctorDetail$(_context8) {
    while (1) {
...
var getSubscriptionDetails = function getSubscriptionDetails(data) {
  var loginToken, myHeaders, bearerTokern, requestOptions, response, regResponse;
  return regeneratorRuntime.async(function getSubscriptionDetails$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 7:
          ...
          _context9.next = 11;
          return regeneratorRuntime.awrap(fetch("https://cms.onlineaarogya.com/api/get-all-subscription"));
...
var resendOtpRequest = function resendOtpRequest(data) {
  var raw, requestOptions, response, regResponse;
  return regeneratorRuntime.async(function resendOtpRequest$(_context10) {
    while (1) {
...
var getSupportTicket = function getSupportTicket(data) {
  var loginToken, myHeaders, bearerTokern, requestOptions, response, regResponse;
  return regeneratorRuntime.async(function getSupportTicket$(_context11) {
    while (1) {
...
var raiseSupportTicket = function raiseSupportTicket(data) {
  var loginToken, myHeaders, bearerTokern, recordData, requestOptions, response, regResponse;
  return regeneratorRuntime.async(function raiseSupportTicket$(_context12) {
    while (1) {
