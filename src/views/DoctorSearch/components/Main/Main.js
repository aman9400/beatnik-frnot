...
const Main = props => {
  ...
  const onDateCLickGetSchedule = async (
    slotDate,
    doctorID,
    getAppointmentId,
  ) => {
  ...
  const onWalkInDateButtonClick = async (
    slotDate,
    doctorID,
    getAppointmentId,
  ) => {
  ...
  // const handleDateChanges = (date,docId,appointmentId) => {
  //   // alert(date)
                                      ...
                                      {getAddressOnWalkDateClick == ''
                                        ...
                                        getAddressOnWalkDateClick.map(
                                          data => (
                                            <button
                                              className={
                                                styles.clinic_address
                                              }
                                              onClick={e =>
                                                getSlotByWalkInClinicDateAddress(
                                                  data.id,
                                                  recordData.id,
                                                )
                                              }
