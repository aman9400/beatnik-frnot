...
exports.integrations = exports.support = exports.reviews = void 0;
var reviews = [{
  logo: 'https://assets.maccarianagency.com/the-front/logos/slack.svg',
  title: 'Slack',
  city: 'Milan',
  feedback: 'A very simple and modern template with a very harmonious color scheme. Also the additional plugins like the statistics are great and fit perfectly into the overall picture.'
}, {
...
var support = {
  items: ['Speedy', 'Global team', '5 Star reviews', 'Good looking'],
  team: [{
    authorPhoto: {
