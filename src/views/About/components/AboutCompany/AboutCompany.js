...
import CompanyMD from './../../../../../public/assets/Images/common/bg-column-left.jpg';
  ...
  return (
    <div className={styles.about_main}>
      <Grid container className={styles.root} spacing={2}>
        <Grid item xs={6}>
          <Grid container>
            <Grid className={styles.owner}>
              <img src={CompanyMD} alt="#" />
            </Grid>
          </Grid>
        </Grid>
        <Grid item xs={6}>
          <Grid container>
            <Grid item>
              <div className={styles.about_container}>
                ...
                <h3>Online Aarogya Consultation Pvt. Ltd.</h3>
                <p>
                  We provide the special tips and advice’s of heath care
                  treatment and high level of best technology involve in the our
                  hospital.
                </p>
                <p>We provide the special tips and advice’s of heath care treatment and high level of best technology involve in the our hospital.We provide the special tips and advice’s of heath care treatment and high level of best technology involve in the our hospital.</p>
                <Grid container spacing={2}>
                  <Grid item xs={6}>
                    <div className={styles.feature_container}>
                      <div className={styles.icon_md}>
                        <span className={styles.icon_cell}>
                          <svg
