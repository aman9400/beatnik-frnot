...
{/* spacing={isMd ? 4 : 2} */}
    {/* <Box mb={6} style={{borderTop:"1px solid #dfdfe5"}}></Box> */}
       <Grid container spacing={isMd ? 4 : 2}>
        
        <Grid   item xs={12} md={5}  data-aos="fade-up">
        <Box sx={{ boxShadow:5 }}>
         {/* <Card sx={{ maxWidth:224}}  style={{padding:"40px"}}> */}
           ...
           <Box mt={3}> 
            ...
            <Box mt={3}> 
              <Button href="#contained-buttons" size="large" color="primary" variant="contained">See All Articles</Button>
            </Box>
          {/* <CardContent>
          </CardContent>
         </Card> */}
       ...
       <Grid   item xs={12} md={3}  data-aos="fade-up">
         <Card sx={{ maxWidth:224}} className={classes.card_color}>
          ...
          />
          <CardContent>
           <Typography gutterBottom style={{fontWeight:"700"}} component="div">
              Consult Doctor
            </Typography>
            <Typography variant="body2" color="text.secondary">
       ...
       <Grid   item xs={12} md={3}  data-aos="fade-up">
         <Card sx={{ maxWidth:224}} className={classes.card_color}>
          ...
          />
          <CardContent>
            <Typography gutterBottom  component="div" style={{fontWeight:"700"}}>
